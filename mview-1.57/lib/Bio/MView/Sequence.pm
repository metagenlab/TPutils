...
# $Id: Sequence.pm,v 1.13 2013/09/09 21:31:04 npb Exp $
...
$Mark_Fs1 = "\004";    #frameshift '/' from fast[xy], tfast[axy]
$Mark_Fs2 = "\005";    #frameshift '\' from fast[xy], tfast[axy]
...
#return effective sequence length given by lower/upper bounds
sub ungapped_length {
    if (!defined $_[0]->{'ungapped_length'}) {
...
#leader/trailer padding symbol or gap symbol or space or frameshift
sub is_non_sequence {
    $_[1] eq $Mark_Pad or $_[1] eq $Mark_Gap or $_[1] eq $Mark_Spc
	or $_[1] eq $Mark_Fs1 or $_[1] eq $Mark_Fs2;
}

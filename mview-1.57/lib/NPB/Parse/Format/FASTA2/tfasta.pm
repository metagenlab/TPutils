...
# $Id: tfasta.pm,v 1.12 2013/09/09 21:31:05 npb Exp $

###########################################################################
package NPB::Parse::Format::FASTA2::tfasta;
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::HEADER;
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::RANK;
	   ...
	   $/xo) {
	    ...
	    push(@{$self->{'hit'}},
		 { 
		  ...
		  'desc'   => $2,
		  'frame'  => NPB::Parse::Format::FASTA::parse_frame($3),
		  'orient' => NPB::Parse::Format::FASTA::parse_orient($3),
		  'initn'  => $4,
		  'init1'  => $5,
		  'opt'    => $6,
		  'zscore' => $7,
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::TRAILER;
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::MATCH;
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::MATCH::SUM;
...
###########################################################################
package NPB::Parse::Format::FASTA2::tfasta::MATCH::ALN;

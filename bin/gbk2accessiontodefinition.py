...
def get_coressp(gbk_file_list, molis_table=None, use_gbk_file_names=False):
    ...
    for file in gbk_file_list:
        ...
        for i, record in enumerate(records):
            ...
            description = re.sub(" NODE.*", "", description)
            description = re.sub(" D_2_scaffold1.*", "", description)
            description = re.sub(" scaffold.*", "", description)
            description = re.sub("_scaffold.*", "", description)
            description = re.sub(" Scaffold.*", "", description)
            description = re.sub(" genome.*", "", description)
            description = re.sub(" Contig.*", "", description)
            description = re.sub("Q335DRAFT_scaffold000011.*", "", description)
            description = re.sub("B092DRAFT_scaffold_01.*", "", description)
            description = re.sub("Q335DRAFT_scaffold000011.*", "", description)
            description = re.sub("Q335DRAFT_scaffold000011.*", "", description)
            description = re.sub("H537DRAFT_scaffold000011.*", "", description)
            description = re.sub("H566DRAFT_scaffold000011_C.*", "", description)
            description = re.sub("NML03_0171_S19_L001_001_1.*", "", description)
            description = re.sub("Ga0310543_101.*", "", description)
            description = re.sub("Ga0310505_101.*", "", description)
            description = re.sub("Ga0310531_11.*", "", description)
            description = re.sub("NML03_0171_S19_L001_001_1.*", "", description)
            description = re.sub("NML080357_S20_L001_001_1.*", "", description)
            description = re.sub("PROKKA_.*", "", description)
            description = re.sub("Ga0310503_11.*", "", description)
            description = re.sub("genomo", "", description)
            description = re.sub("H143DRAFT_scaffold000011.*", "", description)
            description = re.sub("H143DRAFT_scaffold000011.*", "", description)
            description = re.sub("H143DRAFT_scaffold000011.*", "", description)
            description = re.sub("H143DRAFT_scaffold000011.*", "", description)
            description = re.sub("H143DRAFT_scaffold000011.*", "", description)
